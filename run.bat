pytest -s -v -m "sanity" --capture=sys --html=Reports/report1.html --self-contained-html testCases/ --browser chrome
pytest -s -v -m "sanity" --capture=sys --html=Reports/report2.html --self-contained-html testCases/ --browser firefox

@REM pytest -s -v --capture=sys --html=Reports/report2.html --self-contained-html testCases/ --browser chrome
@REM pytest -s -v --capture=sys --html=Reports/report2.html --self-contained-html testCases/ --browser firefox
